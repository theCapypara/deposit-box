...
pub struct Win64ArtifactType;

#[async_trait]
impl ArtifactType for Win64ArtifactType {
    async fn describe<'a>(
        &self,
    ...
    async fn get_artifact<'a>(
        ...
        Ok(ArtifactInfo::new_file(
            ArtifactDisplayTitle::Descriptive {
                ...
                descriptive_title: "Windows (64-bit)".into(),
            },
            Some("win64.png".into()),
    ...
    async fn get_nightly_artifact_info<'a>(
        ...
        Ok(ArtifactInfo::new_empty(
            ArtifactDisplayTitle::Simple("Windows (64-bit)".into()),
            Some("win64.png".into()),
        ))
    }
